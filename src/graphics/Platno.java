...
public class Platno {
    ...
    public static Platno dajPlatno() {
        if (Platno.platnoSingleton == null) {
            Platno.platnoSingleton = new Platno("Hadik", Platno.sirka, Platno.vyska,
                    Color.black);
        }
    ...
    private static int sirka = 610;
    private static int vyska = 610;
    ...
    private Platno(String titulok, int sirka, int vyska, Color pozadie) {
        ...
        this.frame.setSize(sirka, sirka);
    ...
    public void setVisible(boolean visible) {
        if (this.graphic == null) {
            ...
            this.canvasImage = this.canvas.createImage(size.width + 20, size.height + 20);
...
//        }
    ...
    private class PopisTvaru {
        ...
        public PopisTvaru(Shape tvar, Color farba) {
            this.tvar = tvar;
            this.farba = farba;
        }
